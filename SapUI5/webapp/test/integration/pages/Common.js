sap.ui.define([
	...
	return Opa5.extend("northwind.Product_Data.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["northwind/Product_Data/localService/mockserver"], function (mockserver) {
