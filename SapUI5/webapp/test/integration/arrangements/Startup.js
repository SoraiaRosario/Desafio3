sap.ui.define([
	"sap/ui/test/Opa5",
	"northwind/Product_Data/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("northwind.Product_Data.test.integration.arrangements.Startup", {
